...
public class Instructions extends JFrame {
	...
	public Instructions() {
		...
		JLabel lblFromTheSnakesfirst = new JLabel("from the snakes. Reach Final" ,JLabel.CENTER);
		...
		JLabel lblFinalPositionWins = new JLabel("position and wins the game!!!!" ,JLabel.CENTER);
